...
class PayPalAccess{
    private $key = '<YOUR_PAYPAL_ACCESS_KEY>';
    private $secret = '<YOUR_PAYPAL_SECRET_KEY>';
    private $scopes = 'openid profile email address';                    //e.g. openid email profile https://uri.paypal.com/services/paypalattributes
    private $state;
    private $return_url = '<YOUR_RETURN_URL>/authReturn.php';
    ...
    */
    public function validate_token(){
        ...
        $verification = json_decode($this->run_curl(VALIDATE_ENDPOINT, "POST", $postvals));
