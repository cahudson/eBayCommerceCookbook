...
<a href="http://goo.gl/cPonT" target="_blank"><img src="http://ecx.images-amazon.com/images/I/51B%2B2xm5GkL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA300_SH20_OU01_.jpg" align="right" title="eBay Commerce Cookbook" alt="eBay Commerce Cookbook" height="200px" /></a>
...
<table width="100%">
  ...
  <th rowspan="4" width="5">&nbsp;</th><th width="15">#</th><th width="30%">Title</th><th width="20%">API/Tool</th><th>Description</th>
  <tr>
    <td>2.1</td><td>Customizing a Magento Storefront</td><td>Magento</td><td>Add in Facebook like / use integration in your Magento storefront with a Facebook App, X.Commerce messaging and Magento community edition. <i>No code required.</i></td>
  </tr>
  <tr>
...
<table width="100%">
  ...
  <th rowspan="4" width="5">&nbsp;</th><th width="15">#</th><th width="30%">Title</th><th width="20%">API/Tool</th><th>Description</th>
  <tr>
    <td>3.1</td><td>Autogenerating Coupons</td><td>Magento</td><td>Wrap the new Magento autogeneration of coupons to create a REST API for creating coupons dynamically. <i>No code required</i></td>
  </tr>
  <tr>
...
<a href="http://www.allaboutbirds.org/guide/Mississippi_Kite/id" target="_blank">AllAboutBirds.org - Mississippi Kite</a>
